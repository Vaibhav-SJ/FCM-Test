package com.example.appmomos.fcm.activity;
...
import com.example.appmomos.fcm.R;
import com.example.appmomos.fcm.app.Config;
import com.example.appmomos.fcm.utils.NotificationUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayFirebaseRegId() {
        ...
        if (!TextUtils.isEmpty(regId))
            txtRegId.setText("Firebase Reg Id: \n\n" + regId);
        else
